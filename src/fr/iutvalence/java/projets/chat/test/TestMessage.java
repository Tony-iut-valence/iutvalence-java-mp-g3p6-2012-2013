...
/**
 * class qui test la class Message: crée un message puis affiche sont contenu, ça destination, ça date puis applique la
 * methode tostring ensuite on change le destinataire et on recommence
 * 
 * @author chizatto
 * 
 */
public class TestMessage
{
	...
	public static void main(String[] args)
	{
		...
		pitimessage.setAdresseDest("12:56:91:38:59");
		System.out.println(pitimessage.toString());
